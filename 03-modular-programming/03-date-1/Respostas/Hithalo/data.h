 ...
 *
 * Esta biblioteca contém funções para verificar a validade de uma data,
 * imprimir uma data por extenso, verificar se um ano é bissexto, calcular o
 * número de dias de um mês, comparar duas datas e calcular a diferença em dias
 * entre duas datas.
 *
 */
 ...
 * @return Retorna 1 se a primeira data é maior que a segunda, -1 se a
 *         primeira data é menor que a segunda e 0 se as datas são iguais.
 ...
 * @param mes Mês a ser verificado.
 * @param ano Ano da data.
 * @return Retorna o número de dias até o mês.
*/
