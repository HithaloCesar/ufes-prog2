 ...
 * Dica:
 * Use o scanf para ler as informações do alimento (seguindo a formatação da
 * entrada) e chame a funcao criaAlimento para criar o alimento, passando como
 * parametro as informações lidas pela entrada
 */
tAlimento leAlimento();

/**
 * @brief Reduz a quantidade atual do alimento pela quantidade que será
 *        consumida
...
/**
 * @brief calcula quanta renda o alimento gerou multiplicando o preço pela
...
/**
 * @brief imprime as informações do alimento, seguindo as regras de formatação
 *        do exercicio
 * Exemplo:
 * --------------------
 * Nome: pudim de arroz
