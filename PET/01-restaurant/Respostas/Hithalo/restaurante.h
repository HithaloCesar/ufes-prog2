 ...
 * @return tipo tRestaurante inicializado, com a array de alimentos vazia e
 *         numeroAlimentos zerado
 */
tRestaurante criaRestaurante(char *nome);

/**
 * @brief lê as informações do restaurante e retorna o tipo tRestaurante
 * atualizado a partir da entrada
 * Dica:
 * Aqui usa-se o scanf para ler o nome, numeroAlimentos e os alimentos a serem
 * armazenados na array de alimentos. Após isso, use a funcao criaRestaurante
 * para retornar o tRestaurante inicializado com as informações lidas
...
/**
 * @brief retorna a renda total de todos os alimentos produzidos pelo
 *        restaurante
...
/**
 * @brief imprime as informações do restaurante, seguindo as regras de
 *        formatação do exercicio
 * Exemplo:
 * Nome: Bicho Guloso
 * Alimentos:
 * --------------------
