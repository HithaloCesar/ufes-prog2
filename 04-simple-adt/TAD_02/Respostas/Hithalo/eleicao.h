 ...
 *        invalidos). Ainda nessa função, é lido a quantidade de candidatos e
 *        os candidatos são lidos e armazenados.
 * @return Eleição inicializada.
 */
tEleicao InicializaEleicao();

/**
 * @brief Realiza uma eleição. Nessa função, é lido a quantidade de eleitores e
 *        os eleitores são lidos earmazenados.
