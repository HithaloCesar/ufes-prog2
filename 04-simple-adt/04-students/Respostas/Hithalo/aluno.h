 ...
 * @return int Retorna 1 se a matrícula do aluno1 é maior que a do aluno2, -1
 *         se a matrícula do aluno1 é menor que a do aluno2 e 0 se as
 *         matrículas são iguais.
 */
