 ...
 *
 * Esta biblioteca contém funções para manipulação de datas, como verificação
 * de datas válidas, impressão de datas e cálculo de diferença entre datas.
 */
 ...
 * @return Retorna 1 se a primeira data é maior que a segunda, -1 se a primeira
 *         data é menor que a segunda e 0 se as datas são iguais.
 */
